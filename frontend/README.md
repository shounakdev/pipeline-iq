...
# iPipeline (formerly PipelineIQ) (Intelligent CICD Dashboard)

# iPipeline (formerly PipelineIQ) is an intelligent CI/CD control-plane dashboard that can trigger real pipeline runs, execute Node.js-based projects, run SonarQube quality scans, store build logs, and generate AI-powered DevOps summaries.

The goal of this project is not to replace Jenkins or GitHub Actions. Instead, iPipeline acts as an intelligence layer on top of CI/CD workflows by giving developers better visibility into pipeline health, code quality, failures, warnings, and improvement suggestions.
...
iPipeline analyzes pipeline execution results and classifies them into the following categories:
...
iPipeline currently supports npm-based JavaScript and TypeScript projects.
...
iPipeline solves this problem by combining:
