...
from app.incidents.config import INCIDENT_CORRELATION_WINDOW_MINUTES
...
def get_incident_timeline(
    ...
    return IncidentTimelineResponse(
        incident_id=incident.id,
        incident_number=incident.incident_number,
        timeline=[_timeline_event_response(event) for event in events],
        calculated_incident_metrics=(_calculated_metrics_response(incident)),
    )
    ...
    *,
    ...
    try:
        ...
        repository.create_timeline_event(
            ...
            source=("OPERATOR" if author_user_id is not None else "SYSTEM"),
