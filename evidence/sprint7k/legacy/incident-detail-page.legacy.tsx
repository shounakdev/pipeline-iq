    ...
    try {
      ...
      await apiFetch(
        `/api/incidents/${incidentId}/acknowledge`,
        {
          ...
          body: JSON.stringify({
            note:
              "Incident acknowledged from the incident detail page",
      ...
      setError(
        "Failed to acknowledge the incident.",
      );
    } finally {
      ...
      await apiFetch(
        `/api/incidents/${incidentId}/status`,
        {
          ...
          body: JSON.stringify({
            status: "RESOLVED",
            reason:
              "Incident resolved from the incident detail page",
          }),
        },
      );
